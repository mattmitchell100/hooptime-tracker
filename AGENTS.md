...
- `npm run dev` launches Vite with hot module reload on http://localhost:5173.
...
- Use the `@/*` path alias defined in `tsconfig.json` once files move into subdirectories.
