      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              onClick={onClose}
              className="px-5 py-3 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl font-bold uppercase text-sm"
            >
              Return to Session
            </button>
          </div>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="text-slate-400 text-sm">
                        {opponentLabel} | {periodLabel} | {entry.rosterSnapshot.length} players | {formatDuration(entry.durationSeconds)} total
                      </div>
                    </div>
